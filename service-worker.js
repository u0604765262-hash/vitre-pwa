...
<body>
  ...
  <section class="hero">
    <div class="container hero-grid">
      <div>
        ...
        <p class="lead">Fini le calcul automatique. Ici, on vient voir, on conseille, et on fixe un <strong>prix juste</strong> sur place — sans mauvaise surprise.</p>
        <div class="badges">
        ...
        <div style="display:flex; gap:10px; flex-wrap:wrap; margin-top:10px;">
          ...
          <a class="btn btn-ghost" href="#etapes">Voir des résultats</a>
        </div>
      </div>
      <div class="hero-card">
        <div class="usp">
          ...
          <div class="item"><div class="icon">🕑</div><div>
            <strong>Créneaux flexibles</strong><br><span class="muted">Nous nous adaptons à vos horaires</span>
          </div></div>
        </div>
      </div>
    </div>
  ...
  <section class="container" id="services">
    ...
    <div class="cards">
      ...
      <article class="card"><h3>Baies vitrées & vérandas</h3><p>Grands formats, accès difficile, perches télescopiques.</p></article>
  ...
  <section class="container" id="etapes">
    ...
    <div class="steps">
      <div class="step"><div class="num">1/4</div><h4>Vous décrivez votre besoin</h4><p>Un petit formulaire, quelques photos si besoin.</p></div>
      ...
      <div class="step"><div class="num">4/4</div><h4>Intervention</h4><p>On intervient au créneau qui vous arrange.</p></div>
    </div>
  </section>
  ...
  <section class="container" id="avis">
    ...
    <p class="section-sub">Avis vérifiés Google (API Places). Si rien ne s’affiche, vérifiez la clé API, les restrictions de domaine et la facturation.</p>
    ...
    <div style="margin-top:16px; display:flex; gap:10px; align-items:center; flex-wrap:wrap;">
      ...
      <span class="hint">Chargement automatique depuis ta fiche GMB.</span>
    </div>
  </section>
  ...
  <section class="container" id="devis">
    ...
    <div class="form-wrap">
      <form id="requestForm" novalidate>
        ...
        <div>
          <label>Type de prestation souhaitée</label>
          <div class="check-group">
            <label class="checkbox"><input type="checkbox" name="services" value="Fenêtres"> Fenêtres / châssis</label>
            <label class="checkbox"><input type="checkbox" name="services" value="Baies"> Baies vitrées</label>
            <label class="checkbox"><input type="checkbox" name="services" value="Véranda"> Véranda</label>
        ...
        <div class="grid two">
          <div>
            <label for="slot">Créneau souhaité</label>
        ...
        <div style="display:flex; gap:10px; align-items:center; flex-wrap:wrap; margin-top:6px;">
          ...
          <button class="btn btn-ghost" type="button" id="sendEmailNow">Envoyer directement à contact@bulle-de-savon.fr</button>
  ...
  <section class="container" id="faq">
    ...
    <details>
      <summary>Intervenez-vous le samedi ou tôt le matin ?</summary>
      <p>Oui, nous nous adaptons à vos contraintes horaires (commerces notamment).</p>
    </details>
  </section>
  ...
  <script>
    ...
    if (form) {
      form.addEventListener('submit', async (e) => {
        ...
        if (FORM_ENDPOINT && !FORCE_EMAILJS) {
          // Envoi vers un endpoint serveur si défini (inchangé)
          try {
          ...
          if (FORCE_EMAILJS) {
            ...
            try {
              ...
              // Repli mailto si EmailJS échoue
...
${payload.message}`);
  ...
  <script>
    ...
    function looksLikeOurs(result){
      ...
      const zipOk  = GOOGLE_PLACES.POSTAL_FILTER && addr.includes(GOOGLE_PLACES.POSTAL_FILTER);
    ...
    function initGoogleReviews(){
      ...
      function getDetailsChecked(placeId, onFallback){
        svc.getDetails({
          placeId,
          fields: ['name','rating','user_ratings_total','url','reviews','place_id','formatted_address','geometry','types']
        }, (place, status) => {
